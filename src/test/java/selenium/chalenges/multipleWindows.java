...
public class multipleWindows {
	public static void main(String[] args) {
		...
		// with the Set interface create object, then we take control of child window with get
		// windowhandles method
		Set<String> s1 = driver.getWindowHandles();
		// take control of window one by one with iterator
		Iterator<String> i1 = s1.iterator();
		// First I create while loop and inside i have to call the object and hasnext method
